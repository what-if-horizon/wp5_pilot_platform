...
class LocalClient:
    """Client for local OpenAI-compatible servers (LM Studio, Ollama, vLLM, etc.)."""

    def __init__(self, model_name: str = "local-model", temperature: float = None, top_p: float = None, max_tokens: int = 1024):
