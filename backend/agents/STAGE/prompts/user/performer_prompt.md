...
Your entire response must be the chatroom message and nothing else. Do NOT include:
- Explanations of your reasoning or strategy
- Commentary on which elements you addressed
- Analysis of tone, style, or key elements
- Markdown separators, headers, or formatting around the message
- Quotation marks wrapping the message

If your output contains anything beyond the chatroom message itself, you have failed the task.
